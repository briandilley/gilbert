...
- [PushNotificationService](push-notification-service.md) — additive side-channel that subscribes to ``notification.received`` and fans out to external push providers; this service is unchanged.
