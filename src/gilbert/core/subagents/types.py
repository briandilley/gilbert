...
def builtin_seed_list() -> list[SubagentType]:
    ...
    return [
        SubagentType(
            ...
            temperature=0.4, ai_profile="general-purpose",
        ...
        SubagentType(
            ...
            temperature=0.4, ai_profile="deep-research",
        ...
        SubagentType(
            ...
            temperature=0.1, ai_profile="quick-answer",
        ...
        SubagentType(
            ...
            temperature=0.1, ai_profile="software-engineer",
        ...
        SubagentType(
            ...
            temperature=0.1, ai_profile="code-reviewer",
            max_rounds=12, max_wall_clock_s=300.0,
            execution_mode="sync", deliver_as="inline", built_in=True,
        ),
        SubagentType(
            ...
            temperature=0.3, ai_profile="qa-engineer",
        ...
        SubagentType(
            ...
            temperature=0.4, ai_profile="product-manager",
            max_rounds=12, max_wall_clock_s=300.0,
            execution_mode="sync", deliver_as="inline", built_in=True,
        ),
        SubagentType(
            ...
            temperature=0.4, ai_profile="market-analyst",
            max_rounds=40, max_wall_clock_s=900.0,
            execution_mode="background", deliver_as="report_file", built_in=True,
        ),
        SubagentType(
            ...
            temperature=0.1, ai_profile="fact-checker",
